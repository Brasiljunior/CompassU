...
| Administrative/security audit logs | Up to 24 months, or longer when reasonably necessary for security/legal investigation | Secure deletion after retention period |
...
Deletion should cover, as applicable, authentication identity, profile information, institution assignment/membership, assessment attempts/responses, recommendation records, favorites and other directly user-linked application records. Referential dependencies must be tested before production automation is considered complete.
