...
export default function AdminLayout({children}){return <><AdminSupabaseFetchGuard/><AdminTenantRoleGate/>{children}<AdminAnalyticsPanel/><AdminTrendAnalyticsPanel/><AdminExecutiveInsightsPanel/><AdminForgotPasswordLink/><AdminInstitutionEnhancer/><BatchInvite500/><AdminRoleManagementPanel/></>}
