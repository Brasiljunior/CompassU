...
export const options={setupTimeout:'10m',scenarios:{finalize_50:{executor:'per-vu-iterations',vus:COMPLETIONS,iterations:1,maxDuration:'3m'}},thresholds:{'http_req_failed{phase:finalize}':['rate<0.01'],'http_req_duration{phase:finalize}':['p(95)<5000'],checks:['rate>0.99']}};
